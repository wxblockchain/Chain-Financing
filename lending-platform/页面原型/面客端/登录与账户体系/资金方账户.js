...
(function(CF){
  ...
  function hydrate(a){F.account=F.accounts[a]?JSON.parse(JSON.stringify(F.accounts[a])):blank();F.account.form={...blank().form,...F.account.form};F.account.address=a;F.emailInput=F.account.email;F.upload=F.account.form.file?(F.account.form.fileStatus||'done'):'idle';if(F.upload==='loading'){F.upload='failed';F.account.form.fileStatus='failed';}}
