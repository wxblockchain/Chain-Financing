...
| 借贷广场 · 融资需求与代币质押（WS-324） | 金融服务端（面客） | [v1.0-借贷广场-融资需求与代币质押-原型.html](借贷广场-融资需求与代币质押/v1.0-借贷广场-融资需求与代币质押-原型.html) | [交互与覆盖说明](借贷广场-融资需求与代币质押/README.md)；P-LS-01 融资需求列表 / P-LS-02 融资需求详情（含池内资产变动与融资变动两张图）/ P-LS-03 建池与发布两段式；游客 · 资产方 · 资金方三身份可切换，链上与后端为模拟。**本模块按 WS-324 触发方要求独立建立设计基线，未接入 `_shared/registry.js`，与其他模块不共用壳层与 token**，详见模块 README 第 11 节 |
