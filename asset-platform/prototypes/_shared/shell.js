...
(function (CF) {
  ...
  CF.DICT = {
    en: { stateSwitch:"Prototype · state", prdOpen:"PRD excerpt", close:"Close",
          ...
          navTokenList:"Token List", navFxRates:"FX Rates",
          ...
          navDataSync:"Data sync", navDataSyncAssets:"Data push", navDataSyncBatches:"Sync records",
          navAssetInventory:"Asset inventory",
          navMyConsole:"My Console",
    ...
    zh: { stateSwitch:"原型 · 状态", prdOpen:"PRD 摘录", close:"关闭",
          ...
          navTokenList:"代币清单", navFxRates:"汇率管理",
          navReceivableGroup:"应收账款", navReceivables:"我的应收账款",
          navConfirmReceivables:"应收账款确权",
          navReceivableAdmin:"应收账款",
          navDataSync:"数据同步", navDataSyncAssets:"数据推送", navDataSyncBatches:"同步记录",
